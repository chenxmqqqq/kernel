 ...
 */
#define VERSION_NUMBER "V1.1.0.9"
...
static void rmnet_vnd_update_rx_stats(struct net_device *net,
    ...
    stats64->rx_packets.v.a.a.counter += rx_packets;
    stats64->rx_bytes.v.a.a.counter += rx_bytes;
#else
...
static void rmnet_vnd_update_tx_stats(struct net_device *net,
    ...
    u64_stats_update_begin(&stats64->syncp);
#if (LINUX_VERSION_CODE >= KERNEL_VERSION( 6,0,0 ))
    stats64->tx_packets.v.a.a.counter += tx_packets;
    stats64->tx_bytes.v.a.a.counter += tx_bytes;
#else
...
#endif
#if (LINUX_VERSION_CODE >= KERNEL_VERSION( 6,0,0 ))
            rx_packets = stats64->rx_packets.v.a.a.counter;
            rx_bytes = stats64->rx_bytes.v.a.a.counter;
            tx_packets = stats64->tx_packets.v.a.a.counter;
            tx_bytes = stats64->tx_bytes.v.a.a.counter;
#else
...
static int qmi_wwan_register_subdriver(struct usbnet *dev)
{
    ...
    /* register subdriver */
//start modified by mouse.li@fibocom.com 2022.08.19 JIRA MBB0085-83
    ...
    info->subdriver = subdriver;
#endif
//end modified by mouse.li@fibocom.com 2022.08.19 JIRA MBB0085-83
...
static int qmi_wwan_bind(struct usbnet *dev, struct usb_interface *intf)
{
    ...
    if (!status)
    {
        ...
        if (dev->driver_info->flags & FLAG_NOARP)
        {
            ...
            int lte_a = (idProduct == 0x0104 || idProduct == 0x0109 || idProduct == 0x0112 || idProduct == 0x0116 || idProduct == 0x1000 || idProduct == 0x1001);
...
static const struct usb_device_id products[] = {
    ...
    { QMI_FIXED_RAWIP_INTF(0x2cb7, 0x0112, 0) },  /* Fibocom FG131/FM131/FG132/FM132 */
    { QMI_FIXED_RAWIP_INTF(0x2cb7, 0x0117, 0) },  /* Fibocom FG131/FM131/FG132/FM132 */
    { QMI_FIXED_RAWIP_INTF(0x2cb7, 0x0116, 0) },  /* Fibocom avm */
    ...
    { QMI_FIXED_RAWIP_INTF(0x05c6, 0x90B8, 2) },  /* Fibocom FG131 */
#endif
    { }                    /* END */
};
